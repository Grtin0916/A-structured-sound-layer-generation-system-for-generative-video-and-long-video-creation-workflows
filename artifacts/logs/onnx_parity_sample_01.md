...
- Report: `artifacts/logs/onnx_parity_sample_01.md`

## Input
- Sample source: `/workspace/data/processed/esc10_miniset/valid/5-185579-A-41.wav`
- Sample index: `1`
...
- Mean abs error: `0.0000008250`
- Max abs error: `0.0000061989`
- MSE: `0.0000000000`
- Allclose: `True`
- atol: `0.0001`
- rtol: `0.0001`
...
## Value range
- PyTorch min/max: `-8.8618927002` / `6.3746724129`
- ONNX min/max: `-8.8618888855` / `6.3746776581`

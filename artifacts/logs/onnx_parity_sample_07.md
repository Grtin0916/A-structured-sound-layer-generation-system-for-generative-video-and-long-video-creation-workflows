...
- Report: `artifacts/logs/onnx_parity_sample_07.md`

## Input
- Sample source: `/workspace/data/processed/esc10_miniset/valid/5-195710-A-10.wav`
- Sample index: `7`
...
- Mean abs error: `0.0000009489`
- Max abs error: `0.0000076294`
- MSE: `0.0000000000`
- Allclose: `True`
- atol: `0.0001`
- rtol: `0.0001`
...
## Value range
- PyTorch min/max: `-6.1846694946` / `5.3914380074`
- ONNX min/max: `-6.1846694946` / `5.3914446831`

...
- Report: `artifacts/logs/onnx_parity_sample_06.md`

## Input
- Sample source: `/workspace/data/processed/esc10_miniset/valid/5-194930-A-1.wav`
- Sample index: `6`
...
- Mean abs error: `0.0000336710`
- Max abs error: `0.0001077652`
- MSE: `0.0000000018`
- Allclose: `True`
- atol: `0.0001`
- rtol: `0.0001`
...
## Value range
- PyTorch min/max: `-12.8306427002` / `2.0726056099`
- ONNX min/max: `-12.8306455612` / `2.0726523399`

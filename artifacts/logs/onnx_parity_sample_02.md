...
- Report: `artifacts/logs/onnx_parity_sample_02.md`

## Input
- Sample source: `/workspace/data/processed/esc10_miniset/valid/5-185579-B-41.wav`
- Sample index: `2`
...
- Mean abs error: `0.0000009247`
- Max abs error: `0.0000073910`
- MSE: `0.0000000000`
- Allclose: `True`
- atol: `0.0001`
- rtol: `0.0001`
...
## Value range
- PyTorch min/max: `-5.9194359779` / `3.1140708923`
- ONNX min/max: `-5.9194350243` / `3.1140778065`

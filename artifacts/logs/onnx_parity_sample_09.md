...
- Report: `artifacts/logs/onnx_parity_sample_09.md`

## Input
- Sample source: `/workspace/data/processed/esc10_miniset/valid/5-198411-G-20.wav`
- Sample index: `9`
...
- Mean abs error: `0.0000040244`
- Max abs error: `0.0000095367`
- MSE: `0.0000000000`
- Allclose: `True`
- atol: `0.0001`
- rtol: `0.0001`
...
## Value range
- PyTorch min/max: `-11.4540290833` / `2.5978510380`
- ONNX min/max: `-11.4540319443` / `2.5978567600`
